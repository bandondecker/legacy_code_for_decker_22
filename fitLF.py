...
def makeLF(sample,magbins,title='comp',thresh=0.3):
...
#    name = np.str(thresh)
    ...
    locs = mc.MCMC(mags,lf,lferr,mc.schechter,['mstar','phistar','alpha'],[[18.5,21.5,0.15*2.38],[50,200,15*2.38],[-1.6,-0.1,0.15*2.38]],['flat','flat','flat'],N=110000,N_walkers=10,burnin=10000,burnin_type='int')
